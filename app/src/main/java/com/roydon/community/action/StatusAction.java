        ...
        if (application != null) {
            ...
            if (manager != null) {
                ...
                if (info == null || !info.isConnected()) {
                    showLayout(R.drawable.icon_hint_nerwork, R.string.hint_layout_error_network, listener);
                    return;
                }
            }
        }
        showLayout(R.drawable.icon_hint_error, R.string.hint_layout_error_request, listener);
    }
