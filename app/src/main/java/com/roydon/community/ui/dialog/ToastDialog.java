...
public final class ToastDialog {
    ...
    public static final class Builder
        ...
        public Builder setType(Type type) {
            ...
            switch (type) {
                case FINISH:
                    mIconView.setImageResource(R.drawable.icon_tips_finish);
                    break;
                case ERROR:
                    mIconView.setImageResource(R.drawable.icon_tips_error);
                    break;
                case WARN:
                    mIconView.setImageResource(R.drawable.icon_tips_warning);
                    break;
                default:
                    break;
            }
