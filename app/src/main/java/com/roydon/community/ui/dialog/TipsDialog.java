...
public final class TipsDialog {
    ...
    public final static int ICON_FINISH = R.drawable.icon_tips_finish;
    public final static int ICON_ERROR = R.drawable.icon_tips_error;
    public final static int ICON_WARNING = R.drawable.icon_tips_warning;
